		...
		<div class="card-body">
			<form action="{{ route('menu.store') }}" method="POST">
				...
				<div class="form-group">
					...
					<div>
						<input type="text" name="title" id="ic_title" class="form-control {{ $errors->has('title') ? 'parsley-error' : '' }}" placeholder="Menu name(English)" required/>
					</div>
					@if($errors->has('title'))
				...
				<div class="form-group" id="link-box">
					...
					<div>
						<input type="text" name="link_url" class="form-control" placeholder="Custom link"/>
					</div>
				</div>
